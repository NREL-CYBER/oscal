import { AnnotatedProperty, BackMatter, Component, ControlIdentifierReference, ImportSystemSecurityPlan, InventoryItem, Link, Part, Property, PublicationMetadata, Remarks, ResponsibleParty, ResponsibleRole, SystemUser, AssessmentActivityUniversallyUniqueIdentifier, Action, ControlObjectiveDescription, ReferenedControlObjectives, AssessedControlsDescription, All, ActionReference, ObjectiveDescription, IncludedActivityTitle, IncludedActivityDescription, IncludeSpecificStatements, PartIdentifier, PartName, PartNamespace, PartClass, PartTitle, PartText, ComponentUniversallyUniqueIdentifierReference, ObjectiveID, AssessmentPlatformUniversallyUniqueIdentifier, AssessmentPlatformTitle, EventUniversallyUniqueIdentifier, EventTitle, EventDescription, EventTiming, AssociatedActivity, ActivityInstanceUniversallyUniqueIdentifier } from "src/shared";
import { SubjectType, IncludeSubjectsDescription, UUIDReference } from "src/poam";
import { TaskUniversallyUniqueIdentifier, TaskTitle, TaskDescription, TaskStartDate, TaskEndDate } from "src/shared/Task";
import { AssessmentSubjectPlaceholderDescription } from "src/shared/Subject";
