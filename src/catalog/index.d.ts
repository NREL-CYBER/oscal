...
export interface RevisionHistoryEntry {
  ...
  last_modified?: LastModifiedTimestamp1;
  version?: DocumentVersion1;
  oscal_version?: OSCALVersion1;
  props?: [Property, ...Property[]];
  annotations?: [AnnotatedProperty, ...AnnotatedProperty[]];
  links?: [Link, ...Link[]];
  remarks?: Remarks;
...
export interface PartyOrganizationOrPerson {
  ...
  annotations?: [AnnotatedProperty, ...AnnotatedProperty[]];
  links?: [Link, ...Link[]];
  email_addresses?: [EmailAddress1, ...EmailAddress1[]];
  telephone_numbers?: [TelephoneNumber1, ...TelephoneNumber1[]];
...
export interface Address1 {
  type?: AddressType1;
  addr_lines?: [AddressLine1, ...AddressLine1[]];
  city?: City1;
  state?: State1;
