...
export { exportOscal, importOscal, OrganizationSecurityPolicy, };
 ...
 * The operational status.
 */
export declare enum PurpleState {
 ...
 * An indication as to whether the objective is satisfied or not.
 */
export declare enum ObjectiveStatusState {
 ...
 * Identifies the type of the target.
 */
export declare enum FindingTargetType {
 ...
 * should be assumed to be permitted.
 */
export declare enum ParameterCardinality {
    One = "one",
 ...
 * When a control is included, whether its child (dependent) controls are also included.
 */
export declare enum IncludeContainedControlsWithControl {
    No = "no",
    Yes = "yes"
}
/**
 ...
 * The current operating status.
 */
export declare enum OperatingState {
    Disposition = "disposition",
    Operational = "operational",
    Other = "other",
    UnderDevelopment = "under_development",
