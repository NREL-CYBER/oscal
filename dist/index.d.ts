...
export { exportOscal, importOscal, };
/**
 * UUID v4.
 */
export declare type UniversallyUniqueIdentifier = string;
/**
 ...
 */
export declare type PropertyValue = string;
/**
 ...
 */
export declare type ResponsibleRole = string;
/**
 ...
 */
export declare type ConstraintExpression = string;
/**
 ...
 */
export declare type ResourceHypertextReference = string;
/**
...
export declare type MatchControlsByIdentifier = string;
/**
 ...
 */
export declare type ResponsibleRoleID = string;
/**
 ...
 * A reference to a control with a corresponding id value.
 */
export declare type ControlIdentifierReference2 = string;
/**
 * A reference to a control statement by its identifier
 */
export declare type ControlStatementReference = string;
/**
 ...
 */
export declare type ImplementationState = string;
/**
 ...
 */
export declare type ResponsibilityUniqueIdentifier = string;
/**
 ...
 */
export declare type ComponentReference = string;
/**
 * A globally unique identifier for this catalog instance. This UUID should be changed when this document is revised.
 */
 ...
 */
export declare type InformationTypeSystematizedIdentifier = string;
/**
 ...
 */
export declare type LeveragedAuthorizationTitle = string;
/**
 ...
 */
export declare type UserUniversallyUniqueIdentifier = string;
/**
 ...
 */
export declare type StepUniversallyUniqueIdentifier = string;
/**
 ...
 * A unique identifier for a specific part instance. This identifier's uniqueness is document scoped and is intended to be consistent for the same part across minor revisions of the document.
 */
export declare type AssessmentPartIdentifier = string;
/**
 * A textual label that uniquely identifies the part's semantic type.
 */
export declare type AssessmentPartName = string;
/**
 * A namespace qualifying the part's name. This allows different organizations to associate distinct semantics with the same name.
 */
export declare type AssessmentPartNamespace = string;
/**
 * A textual label that provides a sub_type or characterization of the part's name. This can be used to further distinguish or discriminate between the semantics of multiple parts of the same control with the same name and ns.
 */
export declare type AssessmentPartClass = string;
/**
 * A name given to the part, which may be used by a tool for display and navigation.
 */
export declare type AssessmentPartTitle = string;
/**
 * Permits multiple paragraphs, lists, tables etc.
 */
export declare type AssessmentPartText = string;
/**
 ...
 */
export declare type SubjectUniversallyUniqueIdentifierReference = string;
/**
 * Used to indicate the type of object pointed to by the uuid_ref within a subject.
 */
export declare type SubjectUniversallyUniqueIdentifierReferenceType = string;
/**
 ...
 */
export declare type ComponentUniversallyUniqueIdentifierReference2 = string;
/**
 ...
 */
export declare type ActorRole = RoleIdentifier;
/**
 * References a unique assessment subject placeholder defined by this task.
 */
export declare type AssessmentSubjectPlaceholderUniversallyUniqueIdentifierReference = string;
/**
 ...
 */
export declare type ActorUniversallyUniqueIdentifierReference = string;
/**
 * For a party, this can optionally be used to specify the role the actor was performing.
 */
export declare type OriginActorRole = RoleIdentifier;
/**
 ...
 */
export declare type EventStart = string;
/**
 ...
 */
export declare type EventEnd = string;
/**
 ...
 */
export declare type FindingTargetIdentifierReference = string;
/**
 ...
 */
export declare type ObjectiveStatusReason = string;
/**
