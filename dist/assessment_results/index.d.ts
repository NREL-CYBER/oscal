 ...
 * A reference to a control identifier.
 */
export declare type ControlIdentifierReference1 = string;
/**
 ...
 * A key word to indicate all.
 */
export declare type All1 = string;
/**
 ...
 */
export declare type State1 = "under_development" | "operational" | "disposition" | "other";
/**
 ...
 */
export declare type TitleField1 = string;
/**
 ...
 */
export declare type OnDateCondition1 = string;
/**
 ...
 * A key word to indicate all.
 */
export declare type All2 = string;
/**
 ...
 * A reference to a component that is implemented as part of an inventory item.
 */
export declare type ComponentUniversallyUniqueIdentifierReference1 = string;
/**
 * A unique identifier for a specific part instance. This identifier's uniqueness is document scoped and is intended to be consistent for the same part across minor revisions of the document.
 */
export declare type PartIdentifier1 = string;
/**
 * A textual label that uniquely identifies the part's semantic type.
 */
export declare type PartName1 = string;
/**
 * A namespace qualifying the part's name. This allows different organizations to associate distinct semantics with the same name.
 */
export declare type PartNamespace1 = string;
/**
 * A textual label that provides a sub_type or characterization of the part's name. This can be used to further distinguish or discriminate between the semantics of multiple parts of the same control with the same name and ns.
 */
export declare type PartClass1 = string;
/**
 * A name given to the part, which may be used by a tool for display and navigation.
 */
export declare type PartTitle1 = string;
/**
 * Permits multiple paragraphs, lists, tables etc.
 */
export declare type PartText1 = string;
/**
 * Uniquely identifies an assessment event. This UUID may be referenced elsewhere in an OSCAL document when refering to this information. A UUID should be consistantly used for this schedule across revisions of the document.
 */
 ...
 * The title for this event.
 */
export declare type ActionTitle1 = string;
/**
 * A human_readable description of this event.
 */
 ...
 * The title for this event.
 */
export declare type ActionTitle2 = string;
/**
 * A human_readable description of this event.
 */
export declare type ActionDescription2 = string;
/**
 * Identifies the start date and time of an event.
 */
export declare type Start2 = string;
/**
 * Identifies the end date and time of an event. If the event is a point in time, the start and end will be the same date and time.
 */
export declare type End2 = string;
/**
 * Describes the status of the associated risk.
 */
...
export interface RiskLogEntry {
    ...
    related_responses?: ActionReference1[];
    remarks?: Remarks;
}
/**
...
export interface Finding {
    ...
    related_observations?: RelatedObservation1[];
...
export interface ObjectiveStatus {
    ""?: string;
    control_id?: ControlIdentifierReference2;
