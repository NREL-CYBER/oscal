 ...
 * When a control is included, whether its child (dependent) controls are also included.
 */
export declare type IncludeContainedControlsWithControl1 = "yes" | "no";
/**
 ...
 * When a control is included, whether its child (dependent) controls are also included.
 */
export declare type IncludeContainedControlsWithControl2 = "yes" | "no";
/**
 ...
 * A textual label that provides a characterization of the parameter.
 */
export declare type ParameterClass1 = string;
/**
 * Another parameter invoking this one
 */
export declare type DependsOn1 = string;
/**
 * A short, placeholder name for the parameter, which can be used as a subsitute for a value if no value is assigned.
 */
export declare type ParameterLabel1 = string;
/**
 * Describes the purpose and use of a parameter
 */
export declare type ParameterUsageDescription1 = string;
/**
 * Value of the 'id' flag on a target control
 */
export declare type ControlID1 = string;
/**
...
export interface Call {
    ...
    with_child_controls?: IncludeContainedControlsWithControl1;
}
/**
...
export interface MatchControlsByIdentifier {
    pattern?: Pattern;
    order?: Order;
    with_child_controls?: IncludeContainedControlsWithControl2;
}
/**
