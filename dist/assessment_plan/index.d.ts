import { ActionReference, Activity, All, AssessmentPlatformTitle, AssessmentPlatformUniversallyUniqueIdentifier, AssociatedActivity, BackMatter, Component, ComponentUniversallyUniqueIdentifierReference, ControlIdentifierReference, EventDescription, EventTiming, EventTitle, EventUniversallyUniqueIdentifier, ImportSystemSecurityPlan, IncludeSubjectsDescription, InventoryItem, Link, ObjectiveDescription, Part, PartClass, PartIdentifier, PartName, PartNamespace, PartText, PartTitle, Property, PublicationMetadata, Remarks, ResponsibleParty, ResponsibleRole, ReviewedControlsAndControlObjectives, RoleIdentifier, SelectControl, SubjectType, SystemUser, UUIDReference } from "../shared";
