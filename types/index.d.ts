 ...
 */
export type OperationalState = "operational" | "under_development" | "under_major_modification" | "disposition" | "other";
/**
 ...
 */
export type AuthenticationTitleField = string;
/**
 ...
 */
export type PrivelegedTitleField = string;
/**
 ...
 */
export type ProtocolTitleField = string;
/**
...
export interface SystemSecurityPlan {
  ...
  control_implementation: ControlImplementationSet;
...
export interface LeveragedAuthorization {
  ...
  title: AuthenticationTitleField;
  props?: Property[];
  annotations?: AnnotatedProperty[];
  links?: Link[];
...
export interface ControlGroup {
  ...
  groups?: ControlGroup[];
  calls?: Call[];
  matches?: MatchControlsByIdentifier[];
}
/**
...
export interface CustomGrouping {
  groups?: ControlGroup[];
  id_selectors?: Call[];
  pattern_selectors?: MatchControlsByIdentifier[];
}
/**
...
export interface RiskLogEntry {
  ...
  related_responses?: ActionReference[];
  remarks?: Remarks;
}
/**
